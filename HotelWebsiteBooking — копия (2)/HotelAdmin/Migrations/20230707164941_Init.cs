    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TariffAdmins_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "admin@mail.ru", "$2a$11$7mFchA.hOPiYnEWzLt8cIOKfCwQ6262E4rw2AdN8SZJQ7gKUxTmOm" });

            migrationBuilder.InsertData(
                table: "Categorys",
                columns: new[] { "Id", "Name", "Persons_count", "Photo", "Square" },
                values: new object[,]
                {
                    { 1, "Стандарт", 2, "img/room/room-s.jpeg", "20кв.м" },
                    { 2, "Стандарт с большой кроватью", 2, "img/room/room-sb.jpg", "20кв.м" },
                    { 3, "Стандарт Улучшенный", 2, "img/room/room-si.jpeg", "25кв.м" },
                    { 4, "Стандарт Улучшенный с большой кроватью", 2, "img/room/room-sbi.jpeg", "25кв.м" },
                    { 5, "Полулюкс", 4, "img/room/room-pl.jpg", "32кв.м" },
                    { 6, "Люкс", 4, "img/room/room-l.jpg", "46кв.м" }
                });
            ...
            migrationBuilder.InsertData(
                table: "TariffAdmins",
                columns: new[] { "Id", "CategoryId", "Price", "RoomId", "TariffPlanId" },
                values: new object[,]
                {
                    { 1, 1, 3600, null, 1 },
                    { 2, 1, 4800, null, 2 },
