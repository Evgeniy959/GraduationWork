...
namespace HotelWebsiteBooking.Controllers
{
    public class RoomController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Number,Photo,Сategory,Price,PersonsCount")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Number,Photo,Сategory,Price,PersonsCount")] Room room)
        {
            if (id != room.Id)
            {
                return NotFound();
